...
o.default = o.disabled
o.rmempty = false
o.description = translate("Enable zero-copy send with MSG_ZEROCOPY for better performance. Requires kernel 4.14+. Recommended only when experiencing performance bottlenecks.")
